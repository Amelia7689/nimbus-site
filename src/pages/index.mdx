...
<Box top={{ xs: 144, lg: 190 }}>
  <FeatureList
    ...
    features={[
      ...
      {
        title: 'Lightweight',
        description: "Nimbus' low resource footprint makes it an attractive option for solo stakers. Its low CPU and memory consumption is also attractive for institutional node operators, as it leaves more headroom on a server when the Ethereum network is under stress, reducing the risk of failover."
      },
      {
        title: 'Resilient',
